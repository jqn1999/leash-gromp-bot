...
| `takeBounty.js` | `/take-bounty mode:<Regular Bounty\|Baby Bounty>` | Resolves a bounty attempt immediately (no confirm) — Regular Bounty rolls one of 12 tiers auto-selected by your power, Baby Bounty always resolves the guaranteed easiest tier — see [systems/mercenary-bounties.md](../systems/mercenary-bounties.md) |
| `robNpc.js` | `/rob-npc` | Solo heist against a fictional target, 30 min cooldown shared across 4 player-picked tiers (Corner Store/Payroll Truck/Armored Vault/The Big Score, gated by Mercenary Rank) — Corner Store stays whiff-only, the other 3 carry a real loss on a miss — see [systems/mercenary-bounties.md](../systems/mercenary-bounties.md) |
