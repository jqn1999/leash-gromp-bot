...
module.exports = {
    ...
    callback: async (client, interaction) => {
        ...
        const work = await dynamoHandler.getStatsDatabase('work');
        ...
        await dynamoHandler.updateStatsDatabase('work', 'workCount', work.workCount);
        await dynamoHandler.updateStatsDatabase('work', 'totalPayout', work.totalPayout + potatoesGained);
        return;
    }
}